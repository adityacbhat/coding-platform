    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-6 flex items-center justify-center gap-6 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-400">Has content</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded bg-slate-800/80 border border-slate-700/50" />
      ...
      <div className="mt-10 bg-slate-900/30 border border-slate-800 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-white mb-3">How to use this roadmap</h3>
        <ul className="space-y-2 text-slate-400 text-sm">
          <li className="flex items-start gap-2">
            <span className="text-blue-400 mt-0.5">1.</span>
            <span>Start from the top with <strong className="text-white">General Concepts</strong> - Python syntax and built-ins, then <strong className="text-white">Arrays & Hashing</strong></span>
          </li>
          <li className="flex items-start gap-2">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>Focus on <strong className="text-white">recognizing when</strong> to use a pattern, not memorizing solutions</span>
          </li>
        </ul>
      </div>
    </div>
